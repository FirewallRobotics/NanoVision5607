...
import cscore as cs
#ßimport hubvisiongrip
from hubvisiongrip import Hub
...
cvMjpegServer = cs.MjpegServer("hub", 5802)#here
cvMjpegServer.setSource(cvSource)
cvMjpegServerMid = cs.MjpegServer("hubPipeline`", 8082)#here
...
while True:
    ...
    if time == 0:
        ...
        continue
    image_pipeline = hubimage.process(imageorg)
    cvSourceMid.putFrame(image_pipeline)
    contours = hubimage.findContours()
