...
def main( ):
    ...
    #Mat srcRaw
    srcRaw = imread("goal.png", CV_LOAD_IMAGE_COLOR)
    goal.process(srcRaw)
    src = goal.cv_dilate_output
    #Mat gray
    ...
    i = 0
    for i in contours.size(): ##had i++, go back through
    ...
    color( 255,255,255)  ##color of the contour in the
